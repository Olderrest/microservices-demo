...
public class KafkaStreamsRunner implements StreamsRunner<String, Long> {
    ...
    public KafkaStreamsRunner(KafkaStreamsConfigData kafkaStreamsConfig, KafkaConfigData kafkaConfig, @Qualifier("streamConfiguration") Properties streamsConfiguration) {
